...
class ProductsController extends CommonProductsController
{
    ...
    {
        //There is no extra fields for normal products, so we just leave it empty here (if you extend an absract class, all its abstract functions must be implemented)
    }

    //we have implemented the abstract function customFrom and customGrid
    /**
     * Make a grid builder.
     *
     * @return Grid
